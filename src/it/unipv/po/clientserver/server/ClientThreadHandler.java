package it.unipv.po.clientserver.server;

import java.net.*;
import java.io.*;
import it.unipv.po.clientserver.client.*;
...
public class ClientThreadHandler extends Thread{
	...
	/**
	 * Quando si avvia, il thread crea i collegamenti TCP con il client che si è connesso correttamente al server
	 * e ci comunica
	 */
	@Override
	public void run() {
