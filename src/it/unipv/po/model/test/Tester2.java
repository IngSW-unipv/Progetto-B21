...
public class Tester2 {
	...
	public static void main(String[] args) {
		...
		BotPlayer four = new BotPlayer("BOT B2"); //mazziere
		...
		System.out.println("CARTE A="+board.getTeams().get(0).getCardsCollected().size());
		System.out.println("CARTE B="+board.getTeams().get(1).getCardsCollected().size());
